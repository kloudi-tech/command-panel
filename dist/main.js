  ...
  */
  ...
  function renderShortcuts(shortcut) {
    if (!!shortcut) {
      ...
      }, /*#__PURE__*/React__default.createElement("kbd", null, shortcut[0]));else {
        var data = [];
  ...
  function ModalCommandPanel(props) {
    ...
    var _useState3 = React.useState(props.closeOnSelect || false),
    ...
    var _useState9 = React.useState(props.showSpinnerOnSelect || false),
